...
<body>
  ...
  <div id="dodawanie">
	...
	<div id="pod">Zmiana hasła użytkownika</div>
	
    <form method="post" action="pass">
	
       <input type="text" name="nazwa_uzytkownika" placeholder="Nazwa pracownika:"/>

       <input type="password" name="haslo"  pattern=".{8,}" title="8 lub więcej znaków" placeholder="Nowe hasło: " required/>
  
       <input type="password" name="haslo1"  pattern=".{8,}" title="8 lub więcej znaków" placeholder="Powtórz nowe hasło:" required/>

<p>${hasloerr}</p>
<p>${nazwaerr}</p>

       <button type="submit" class="btn" name="add_p">Zmień</button>
    </form>
	<br>
