...
<body>
	...
	<div id="user">
		...
		if(rank!=3){response.sendRedirect("index.jsp");}
		if(user!=null){
		%>
		<div class="w1">
		<a href="koszyk.jsp">
  ...
  <div id="dodawanie">
	...
	<div id="pod">Dodawanie konta pracownika</div>
	
    <form method="post" action="addPR">
	
       <input type="text" name="nazwa_uzytkownika" placeholder="Nazwa pracownika:"/>

       <input type="password" name="haslo"  pattern=".{8,}" title="8 lub więcej znaków" placeholder="Hasło: " required/>
  
       <input type="password" name="haslo1"  pattern=".{8,}" title="8 lub więcej znaków" placeholder="Powtórz hasło:" required/>
